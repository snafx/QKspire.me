    ...
    <form action="add-new-recipe" method="post">
        <div class="col-md-8">
            <div class="form-group">
                ...
                <input class="form-control" placeholder="what do you want to share with us?" name="recipeTitle"
                       type="text" maxlength="69" required/>
            </div>
            <div class="form-group">
                <label>Short recipe description:</label>&nbsp<i class="fa-5 fa-asterisk" aria-hidden="true"></i>
                <input class="form-control" placeholder="what is it?" name="recipeDesc" type="text" maxlength="255"
                       required/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" placeholder="time to make?" name="prepTime" type="text" maxlength="10"
                       required/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" placeholder="nutrition per serving (in kcal)?" name="nutrition"
                       type="number" min="0" step="1"/>
            </div>
            <div class="form-group">
                <label>Method:</label>&nbsp<i class="fa-5 fa-asterisk" aria-hidden="true"></i>
                <textarea class="form-control" onkeydown="countChar(this)" rows="6"
                          placeholder="tell us how to make it..." name="recipeMethod" type="text" maxlength="1000"
                          required></textarea>
                <div class="col-sm-12">
            ...
            <div class="form-group">
                <label>Method:</label>
                <textarea class="form-control" onkeydown="countChar2(this)" rows="6"
                          placeholder="if you need more space..." name="recipeMethod2" type="text"
            ...
            <div class="form-group">
                <label>Method:</label>
                <textarea class="form-control" onkeydown="countChar3(this)" rows="6" placeholder="and more..."
                          name="recipeMethod3" type="text" maxlength="1000"></textarea>
                <div class="col-sm-12">
                    <div class="col-md-11"></div>
            ...
            <div class="form-group">
                <label>Method:</label>
                <textarea class="form-control" onkeydown="countChar4(this)" rows="6" placeholder="and more..."
                          name="recipeMethod4" type="text" maxlength="1000"></textarea>
                <div class="col-sm-12">
                    <div class="col-md-11"></div>
            ...
            <div class="form-group">
                <label>Method:</label>
                <textarea class="form-control" onkeydown="countChar5(this)" rows="6" placeholder="and more..."
                          name="recipeMethod5" type="text" maxlength="1000"></textarea>
                <div class="col-sm-12">
                    <div class="col-md-11"></div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input class="form-control" placeholder="ingredient 1 (one required)" name="ingredient1" type="text"
                       required/>
            </div>
            <div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" placeholder="enter link to recipe photo (http://...)" name="photoLink"
                       type="text" required/>
            </div>
            <%--<div class="form-group">--%>
